  ...
  return (
    <section className="section">
      <div className="shell opportunity-detail-grid">
        <div>
          <SectionHeading eyebrow="Overview" title="A concept for a more considered ownership journey." copy={opportunity.overview} />
        ...
        <aside className="selection-note">
          ...
          <p>This illustrative concept highlights the qualities people may weigh when exploring a homeownership pathway: accessibility, location, everyday living and long-term possibility.</p>
          <small>Partner attribution is intentionally undisclosed: this is not a confirmed project or live opportunity.</small>
        </aside>
      </div>
    </section>
  );
